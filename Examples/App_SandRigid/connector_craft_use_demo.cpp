...
connector_craft_use_demo* connector_craft_use_demo::m_instance = 0;
void connector_craft_use_demo::createScene(const VPE::SandSimulationRegionCreateInfo& info)//可能是这个问题：set和add把参数导进去了，但是create没有用之前的region对象。
{

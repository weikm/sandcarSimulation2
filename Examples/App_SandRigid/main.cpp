...
int main()
{
	...
	std::cout << "   4:  two car" << std::endl;
	std::cout << "   5:  connector" << std::endl;
	std::cout << "   9:  mud rigidsphere interaction" << std::endl;
	std::cout << "   11: 4 wing craft" << std::endl;
    int caseid = 0;
    std::cin >> caseid;
  ...
  //      }
		...
		case 14: {  
            DemoHeightFieldFixedWingUAVs* demo = DemoHeightFieldFixedWingUAVs::getInstance();
            demo->createScene();
            demo->run();
            break;
        }
